...
SECRET_KEY = 'django-insecure-=$r0$+aaub#vo40bv*@l5o%st!4j)ql%+z45#eivzgi6kve4bq'
...
#CSRF_TRUSTED_ORIGINS = ['https://xxx.com']  # 你的域名
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'init_command': "SET time_zone = '+08:00'",  # 强制设置数据库时区
            'charset': 'utf8mb4'
        },
        'NAME': 'oms',
        'USER': 'root',
